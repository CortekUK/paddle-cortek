        ...
        <div className="p-4 border-b border-border/30 bg-muted/5 dark:bg-muted/10">
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
            ...
            <Button
              ...
              disabled={loading}
              size="sm"
              className="h-8 gap-2 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-white px-4 sm:ml-auto shadow-sm shadow-primary/15"
            >
