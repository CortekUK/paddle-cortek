-- Fix the current_org_id function without dropping it to avoid dependency issues

-- Recreate current_org_id function to use organization_members table instead of profiles
